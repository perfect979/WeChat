...
*/
    ...
    _msgHandlerMap.insert({GROUP_AUDIO_FRAME, std::bind(&ChatService::groupAudioFrameRq, this, _1, _2, _3)});
    _msgHandlerMap.insert({AUDIO_FRAME, std::bind(&ChatService::oneAudioFrame, this, _1, _2, _3)});
...
void ChatService::groupAudioFrameRq(const TcpConnectionPtr &conn, json &js, Timestamp time)
{
    // 拆包
...
void ChatService::oneAudioFrame(const TcpConnectionPtr &conn, json &js, Timestamp time)
{
...
void ChatService::login(const TcpConnectionPtr &conn, json &js, Timestamp time)
{
    ...
    std::string username = js.value("name", "");
